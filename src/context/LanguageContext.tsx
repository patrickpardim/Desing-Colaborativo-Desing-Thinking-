...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    optionQuickProfile: 'Criar Perfil Rápido',
    optionExistingId: 'Já tenho um ID de Usuário',
    userIdLabel: 'ID de Usuário',
    userIdPlaceholder: 'Ex: #8492 ou LUCAS-8492',
    yourUserIdNotice: 'Seu ID Único é {userId}. Guarde este código para acessar suas salas de outros dispositivos!',
    facilitatorIdNotice: 'Seu ID Único de Facilitador é {userId}. Use este código para acessar os controles da sala de qualquer outro aparelho!',
    savedProfileConnected: 'Conectado como {name} ({userId})',
    useAnotherProfile: 'Trocar ID',
    copyUserId: 'Copiar ID',
    userIdCopied: 'ID Copiado!',
    invalidUserIdAlert: 'Por favor, insira um ID de Usuário válido (ex: #8492 ou LUCAS-8492).',
  ...
  es: {
    ...
    optionQuickProfile: 'Crear Perfil Rápido',
    optionExistingId: 'Ya tengo un ID de Usuario',
    userIdLabel: 'ID de Usuario',
    userIdPlaceholder: 'Ej: #8492 o LUCAS-8492',
    yourUserIdNotice: '¡Tu ID Único es {userId}. Guarda este código para acceder a tus salas desde otros dispositivos!',
    facilitatorIdNotice: '¡Tu ID Único de Facilitador es {userId}. Usa este código para acceder a los controles de la sala desde cualquier otro dispositivo!',
    savedProfileConnected: 'Conectado como {name} ({userId})',
    useAnotherProfile: 'Cambiar ID',
    copyUserId: 'Copiar ID',
    userIdCopied: '¡ID Copiado!',
    invalidUserIdAlert: 'Por favor, ingrese un ID de Usuario válido (ej: #8492 o LUCAS-8492).',
